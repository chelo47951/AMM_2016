...
public class Constant
{
    ...
    public final static String DVD = "DVD";
      ...
      public final static String LIST_JSON_PAGE  = BASE_PATH   +  "listaOggettiJson.jsp";
      ...
      public final static String FILTER_QUERY = "q";
      ...
      // Messages
       ...
       public final static String TOTAL_CHECKOUT_COMMITTED_TEXT = "Effettuato il checkout di tutti gli oggetti richiesti.";
